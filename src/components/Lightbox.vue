<template>
  <transition name="light-transition" v-on:enter="enter" v-on:leave="leave" :css="false">
    <div class="lightbox-container" tabindex="0" v-show="show" @keyup.esc.stop="closeOnEsc">
      <div class="lightbox" ref="dialog">
        <div class="light-images" ref="imagebox" :style="sliderStyle" :class="sliderClass">
          <div class="light-image" v-for="image in this.images" :key="image.id">
...
export default {
  ...
  methods: {
    ...
    leave: function (el, done) {
      ...
      // const rect = this.$refs.image[this.active].getBoundingClientRect()
      // console.dir(rect)
      // const test = rect.left + rect.width / 2
