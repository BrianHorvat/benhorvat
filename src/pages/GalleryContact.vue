    ...
    <div class="container">
      <div class="columns is-centered">
        <div class="column is-half">
          <h1>Contact</h1>
          <p>
            Interested in working together? You may contact me directly at
            <a
              :href="email"
            >{{ meta.social.email }}</a>, or by using the form below.
          </p>
          <form
            class="contact-form"
            method="POST"
          ...
          >
            ...
            <div class="field full-width">
              ...
              <div class="field-item">
                <input
                  name="type"
                  type="text"
                  placeholder="Portraits, Senior Portraits, Branding..."
                  required
                >
                <select name="type">
            ...
            <div class="field full-width">
              ...
              <p
                class="field-desc"
              >If you would like an on location session, please give a full address and any relevant details in the comments section.</p>
              <div class="field-item">
          ...
          <ul class="social-media">
            <li class="social-icon" id="email">
              <a :href="email">
                ...
                >
                  <title id="gmail-icon">{{ meta.social.email }} | Email</title>
                  <path
            ...
            <li class="social-icon">
              <a :href="'tel:' + this.meta.social.phone">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <title id="phone-icon">{{ phone }} | Phone</title>
                  <path
            ...
            <li class="social-icon">
              <a :href="instagram">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <title id="instagram-icon">{{ meta.social.instagram}} | Instagram</title>
                  <path
            ...
            <li class="social-icon">
              <a :href="facebook">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <title id="facebook-icon">{{ meta.social.facebook }} | Facebook</title>
                  <path
...
export default {
  ...
  computed: {
    ...
    phone() {
      const s2 = this.meta.social.phone.replace(/\D/g, '')
